          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', background: 'white', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
            <thead>
              <tr style={{ background: '#f5f0e8', borderBottom: '2px solid #c14d28' }}>
                ...
                <th style={{ padding: '12px', textAlign: 'left', fontWeight: 'bold' }}>Year Built</th>
                <th style={{ padding: '12px', textAlign: 'left', fontWeight: 'bold' }}>Units</th>
                <th style={{ padding: '12px', textAlign: 'left', fontWeight: 'bold' }}>Rent Control</th>
                <th style={{ padding: '12px', textAlign: 'left', fontWeight: 'bold' }}>Evictions</th>
            ...
            <tbody>
              {properties.map((property) => (
                ...
                >
                  <td style={{ padding: '12px' }}>{property.address || 'N/A'}</td>
                  ...
                  <td style={{ padding: '12px' }}>{property.number_of_units || 'N/A'}</td>
